...
from routes.auth import check_jwt_tokens, check_is_clinician, get_user_from_token
from db import list_patients_flagged_by_ai, get_user  
...
def dashboard():
    ...
    return render_template('clinician/patient_cond.html', user = get_user(current_user), patients=list_patients_flagged_by_ai(), current_user=get_user(current_user))
